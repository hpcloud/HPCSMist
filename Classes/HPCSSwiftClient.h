...
/** creates a HPCSSwiftClient
 
 This is the designated initializer
 
 @param client the instance of the HPCSIdentityClient
...
* 
  ...
  @param success A block containing NSHTTPURLResponse from Swift and the NSArray of Containers
         responseObject NSHTTPURLResponse from Swift
         error NSError error generated by last operation
         records NSArray of NSDictionary
...
/**
* Deletes the specified container. All objects in the container must be deleted before the bucket itself can be deleted.
*
...
/**
 Saves the specified object. Once deleted, there is no method to restore or undelete an object.

 @param object The object to save.  Must respond to "parent","parent.name", "name", "mimeTypeForFile", "data"
 @param success Block returning NSHTTPURLResponse from Swift
...
/**
 Retrieves information about an object for a user with read access without fetching the object.
  ...
  @param object The object to save.  Must respond to "parent","parent.name", "name", "mimeTypeForFile", "data"
  @param success Block returning NSHTTPURLResponse from Swift. This will be populated with information about the object
                 in the HTTP header.   For example:
